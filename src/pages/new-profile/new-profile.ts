...
export class NewProfilePage {
	...
	constructor(
		...
		this.form = this.formBuilder.group({
			name: [''],
			heat: ['', [Validators.required, Validators.min(-1), Validators.max(71581)]],
			preserve: ['', [Validators.required, Validators.min(0), Validators.max(71581)]],
			rest: ['', [Validators.required, Validators.min(0), Validators.max(71581)]],
		});
